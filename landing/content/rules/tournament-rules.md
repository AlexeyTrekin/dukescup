...
1. The qualification phase is run in a sort of Swiss system. All the participants begin with the same points (hit-points) at this phase. The exact number of these points will be calculated depending on the participants number. 
...
1. Call the direction of the action ("From red fencer…")
